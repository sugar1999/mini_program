		...
		<view class="contaier" style="background-color: #FFFFFF;">
			<view class="top_bg">
				<view class="one_box">
					...
					<view class="top3">
						<view class="num_two">
							<image class="huangguan2" src="http://p1362.bvimg.com/10465/08a774380c2a8127.png"></image>
					...
					<view class="top3">
						<view class="num_one">
							<image class="huangguan1" src="http://p1362.bvimg.com/10465/1615b869be352671.png"></image>
					...
					<view class="top3">
						<view class="num_three">
							<image class="huangguan2" src="http://p1362.bvimg.com/10465/2dc519f8207fc9d9.png"></image>
				...
				<view class="number_sy_box">
					...
					<view class="number_sy_main">
						...
						<image mode="widthFix" class="xiaoding_bg" src="http://p1362.bvimg.com/10465/0da9d0f482f36101.png"></image>
					</view>
				</view>
			</view>
			...
			<view class="rankList_box">
				<view class="rankItem" v-for="(item,index) in rankList" :key="index">
					...
					<view class="download_box">
						<image mode="widthFix" src="http://p1362.bvimg.com/10465/10259b61eb93b7d7.png"></image>
					</view>
				</view>
			</view>
		</view>
