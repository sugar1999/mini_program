<template>
	<view>
		<view class="wrapper">
			<view class="handBtn">
				<image @click="selectColorEvent('black','#1A1A1A')" :src="selectColor === 'black' ? 'http://p1362.bvimg.com/10465/bd1f420d9b611b58.png' : 'http://p1362.bvimg.com/10465/650f79d070fb5fd1.png'"
				 :class="[selectColor === 'black' ? 'color_select' : '', 'black-select']"></image>
				<image @click="selectColorEvent('red','#ca262a')" :src="selectColor === 'red' ? 'http://p1362.bvimg.com/10465/d47ace1dea1f9d01.png' : 'http://p1362.bvimg.com/10465/e8b0fe7163575d59.png'"
